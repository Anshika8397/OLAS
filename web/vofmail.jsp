<%-- 
    Document   : vofmail
    Created on : Mar 31, 2017, 7:05:36 PM
    Author     : we
--%>
...
<html>
    <head>
     ...
     <body style='background: linear-gradient(to right,lightcyan,white)'> 
        <form name="emailForm" action="vofmail.jsp" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <textarea rows="12" cols="80" name="mess">Congratulations! your ward's leave has been verified successfully.</textarea><br/>
                    </td>
                </tr>
                <tr>
                    <td>
